    ...
    <div id="info" class="modal" >
		...
		<div id="ratingsForm">
			<div id="starrating" class="stars starrating">
				<input type="radio" name="star" class="star-1" id="starnum" />
				<label class="star-1" for="star-1">1</label>
				<input type="radio" name="star" class="star-2" id="starnum" />
				<label class="star-2" for="star-2">2</label>
				<input type="radio" name="star" class="star-3" id="starnum" />
				<label class="star-3" for="star-3">3</label>
				<input type="radio" name="star" class="star-4" id="starnum" />
				<label class="star-4" for="star-4">4</label>
				<input type="radio" name="star" class="star-5" id="starnum" />
